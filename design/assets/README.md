...
- signature-motif-decision-trace.svg
  - Signature motif anatomy and usage pattern.
- case-study-proof-flow.svg
  - Case-study evidence composition: problem -> reasoning -> system -> outcome.
- thesis-block-treatment.svg
